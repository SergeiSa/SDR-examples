function description = SRD_transverse_linearization(varargin)
Parser = inputParser;
...
% perform change of coordinates. The change is hardcoded for the case when
% the moiton generator is the linear combination of  the two
